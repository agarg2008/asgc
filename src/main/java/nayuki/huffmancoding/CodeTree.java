...
public final class CodeTree {
    ...
    public Map<Integer, List<Integer>> getCodes() {
        return codes;
    }
    ...
    private Map<Integer, List<Integer>> codes;

    public CodeTree(InternalNode root, Map<Integer, List<Integer>> codes) {
        this.root = root;
        this.codes = codes;
    }
    ...
    public CodeTree(InternalNode root) {
        ...
        codes = new HashMap<Integer, List<Integer>>();  // Initially all null
